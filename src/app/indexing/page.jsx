...
export const metadata = {
  title: "Database Indexing — Engineering Case Study",
  description:
    "A deep dive into why full table scans crush your database, how composite B-Tree indexes work, and why column order matters.",
};
