...
import { ChevronDown, Database, Server, ServerCrash } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-50">
      ...
      >
        ...
        >
          <span className="text-slate-900">Pagination — Surviving</span>
          <br />
        ...
        >
          When `SELECT *` transforms from a harmless query into a system-crashing 1,000,000 row nightmare — and how to fix it beautifully.
        </motion.p>
